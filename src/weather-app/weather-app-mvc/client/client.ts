...
async function main(): Promise<void> {
  // Uncomment the line below to use the LocalWeatherModel
  // const BUILDER: WeatherBuilder = new WeatherBaseBuilder(new LocalWeatherModel());
  const BUILDER: WeatherBuilder = new WeatherForumBuilder();
  BUILDER.build();
}
