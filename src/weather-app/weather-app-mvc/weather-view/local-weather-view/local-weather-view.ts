 ...
 * @desc View that displays the weather data
...
import { WeatherData, ForecastDay } from '../../data-types.js';

/**
 * View that displays the weather data
 */
export class ForumWeatherView implements WeatherView {
